export const config = {
	...
	positions: {
		...
		top_center: {
			...
			history: {top: "12rem", left: "0", right: "0", margin: "auto", width: "fit-content", textAlign: "center"}
		},
		top_right: {
			nowPlaying: {top: "2rem", right: "2rem", textAlign: "right"},
			history: {top: "12rem", right: "2rem", textAlign: "right"}
		},
		bottom_left: {
			nowPlaying: {bottom: "2rem", left: "2rem", textAlign: "left"},
			history: {bottom: "12rem", left: "2rem", textAlign: "left"}
		},
		bottom_center: {
			nowPlaying: {bottom: "2rem", left: "0", right: "0", margin: "auto", width: "fit-content", textAlign: "center"},
			history: {bottom: "12rem", left: "0", right: "0", margin: "auto", width: "fit-content", textAlign: "center"}
		},
		bottom_right: {
			nowPlaying: {bottom: "2rem", right: "2rem", textAlign: "right"},
			history: {bottom: "12rem", right: "2rem", textAlign: "right"}
		}
	},
	themes: {
		default: {
